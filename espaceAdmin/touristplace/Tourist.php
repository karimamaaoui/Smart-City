      ...
      class Tourist{
        ...
        public function fetchAll(){
            try{
                ...
                $stm=$pdo->prepare('SELECT * FROM touristplace');
                $stm->execute();
                return $stm->fetchAll();
        ...
        public function addTourist(){
            try{
                ...
                $stm=$pdo->prepare('INSERT INTO `touristplace`( `name`, `address`, `description`, `tel`, `idCity`,`pic`)  VALUES (?,?,?,?,?,?)');
            ...
            public function delete(){
                try{
                    ...
                    $stm=$pdo->prepare('DELETE FROM touristplace where id=?');
                    $stm->execute([$this->id]);
                    return $stm->fetchAll();
