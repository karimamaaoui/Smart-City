<?php
    ...
    session_start();
    $listAllTourist=new Tourist();
    $data=$listAllTourist->fetchAll();
...
<div class="sectionUser"> 
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Tourist Place Lists</h2>
                        <a href="createTourist.php" class="btn">Create New Tourist  Place</a>
                    ...
                    if(isset($_SESSION['status']))
                    {
                        ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Tourist Place Deleted Successfuly</strong> 
                                <?= $_SESSION['status']; ?>
                    ...
                    if(isset($_SESSION['statusupdate']))
                    {
                        ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Tourist Place Updated Successfuly</strong> 
                    ...
                    foreach ($data as $key => $val) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                <a href="updateTourist.php?id=<?php echo $val['id']?>&req=update">
                                <input type="button" class="btn btn-warning" value="Update" >
                                 </a>
                                <a href="deleteTourist.php?id=<?php echo $val['id']?>&req=delete">
