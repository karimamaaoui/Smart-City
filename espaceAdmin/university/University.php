      ...
      class University{
        ...
        public function fetchAll(){
            try{
                ...
                $stm=$pdo->prepare('SELECT * FROM university');
                $stm->execute();
                return $stm->fetchAll();
        ...
        public function addUniversity(){
            ...
            public function delete(){
                try{
                    ...
                    $stm=$pdo->prepare('DELETE FROM university where id=?');
                    $stm->execute([$this->id]);
                    return $stm->fetchAll();
                ...
                try{
                    ...
                    if (isset ($_POST )) {
                      ...
                      $address = $_POST['name'];
                        ...
                        $sql = 'UPDATE university SET name=:name, description=:description, tel=:tel, address=:address WHERE id=:id';
                      $statement = $pdo->prepare($sql);
