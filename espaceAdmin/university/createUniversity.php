...
<form action="UniversityProcess.php" method="post" style="width:30%;height:450px;"enctype="multipart/form-data">
...
<option value="<?php echo $row['id'] ?>"><?php echo $row['label']; ?></option>
    ...
    <input type="submit" value="Add" class="btn" name="adduniversity" />
</form>
</div>
</div>
</body>
