      ...
      class Bank{
        ...
        public function fetchAll(){
            try{
                ...
                $stm=$pdo->prepare('SELECT * FROM bank');
                $stm->execute();
                return $stm->fetchAll();
        ...
        public function addbank(){
            try{
                ...
                $stm=$pdo->prepare('INSERT INTO `bank`( `name`, `address`, `description`, `tel`, `idCity`)  VALUES (?,?,?,?,?)');
            ...
            public function delete(){
                try{
                    ...
                    $stm=$pdo->prepare('DELETE FROM bank where id=?');
                    $stm->execute([$this->id]);
                    return $stm->fetchAll();
                  ...
                  //  $city = $statement->fetch(PDO::FETCH_OBJ);
                    if (isset ($_POST )) {
                      ...
                      $address = $_POST['name'];
                        ...
                        $sql = 'UPDATE bank SET name=:name, description=:description, tel=:tel, address=:address WHERE id=:id';
                      $statement = $pdo->prepare($sql);
