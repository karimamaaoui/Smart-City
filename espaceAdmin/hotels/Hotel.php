      ...
      class Hotel{
        ...
        public function fetchAll(){
            try{
                ...
                $stm=$pdo->prepare('SELECT * FROM hotels');
                $stm->execute();
                return $stm->fetchAll();
        ...
        public function addHotels(){
            try{
                ...
                $stm=$pdo->prepare('INSERT INTO `hotels`( `name`, `address`, `description`, `tel`, `idCity`, `pic`)  VALUES (?,?,?,?,?,?)');
            ...
            public function delete(){
                try{
                    ...
                    $stm=$pdo->prepare('DELETE FROM hotels where id=?');
                    $stm->execute([$this->id]);
                    return $stm->fetchAll();
                ...
                try{
                    ...
                    if (isset ($_POST )) {
                      ...
                      $address = $_POST['name'];
                        ...
                        $sql = 'UPDATE hotels SET name=:name, description=:description, tel=:tel, address=:address WHERE id=:id';
                      $statement = $pdo->prepare($sql);
