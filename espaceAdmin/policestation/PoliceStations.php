<?php
    ...
    session_start();
    $listAllStations=new PoliceStation();
    $data=$listAllStations->fetchAll();
            ...
            <div class="details">
                <div class="recentOrders">
                    ...
                    if(isset($_SESSION['status']))
                    {
                        ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Police Station Deleted Successfuly</strong> 
                                <?= $_SESSION['status']; ?>
                    ...
                    if(isset($_SESSION['statusupdate']))
                    {
                        ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <strong>Police Station Updated Successfuly</strong> 
