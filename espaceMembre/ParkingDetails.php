...
$sql = "SELECT * FROM parking WHERE idCity= $id";
...
if ($result->rowCount() > 0) {
  while($row = $result->fetch(PDO::FETCH_ASSOC)) {
    ...
    echo '<p class="card-text"> <img src="../img/undraw_delivery_truck_vt6p.png"> </p> <br/>';
    ...
    echo '<br/> <a href="create.php?id=' . $row["id"] . '" class="button">Make Reservation </a>';
