<?php
    require_once('../espaceAdmin/policestation/PoliceStation.php');
    
    session_start();
    $listPoliceStation=new PoliceStation();
    $data=$listPoliceStation->fetchAll();
...
$sql = "SELECT * FROM policestation WHERE idCity= $id";
