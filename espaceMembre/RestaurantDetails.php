<?php
    require_once('../espaceAdmin/restaurants/Restaurant.php');
    
    session_start();
    $listRestaurant=new Restaurant();
    $data=$listRestaurant->fetchAll();
...
$sql = "SELECT * FROM restaurants WHERE idCity= $id";
